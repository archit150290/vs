...
var ninjaScroll = {
	...
	minWidth	: 300, // Change to minimum window width that this plugin will apply to.
...
if ((ninjaScroll.winW > ninjaScroll.minWidth)) { // If device is not a touch-device, and if the width of the window is big enough
